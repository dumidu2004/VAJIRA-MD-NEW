...
global.owner = process.env.OWNER_NUMBER  || '94762430933' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=3ZFgnTaT#c7rqtv2gWWP44F_dReYJ4UPg8pBZqtEAwK3wHu3Maek' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94762430933" : process.env.MODERATORS ,    
